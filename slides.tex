...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection[Algorithm3]{Scheduling-based Algorithm}


\subsection[Algorithm3: Tree]{Tree Construction}

\subsection[Algorithm3: Motion Strategy]{NO Child Left Behind}

\subsection[Algorithm3: Correctness]{Correctness}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
